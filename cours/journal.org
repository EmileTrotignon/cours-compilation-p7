...
*** Retrolix
    ...
    *Attention* : les six premiers arguments sont passés par %rdi, %rsi,
    etc. Donc les arguments déclarés et passés explicitement en Retrolix sont
    ceux qui viennent des fonctions sources (Fopix) qui avaient plus de six
    arguments au départ !
